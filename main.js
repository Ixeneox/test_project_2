...
//     document.getElementById("container").style.backgroundColor = "#" + hex_code;
//     document.getElementById("colors_hex").innerHTML=hex_code;
// }
...
function showme(){
  ...
  var qoute = quotes[author]

  document.getElementById("qoute_para").innerHTML = qoute ;
  document.getElementById ("author_head").innerHTML=author;
